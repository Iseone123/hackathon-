...
5. Стиль формулировок — как у экспертов в примерах: короткое инженерное предложение, но добавь механизм и параметры.
   Примеры показывают СТИЛЬ, а не содержание: не переноси из них номера мельниц, марки реагентов и другие детали чужих фабрик, если их нет в диагнозе или источниках текущего объекта.
